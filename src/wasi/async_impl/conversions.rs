...
use super::super::wit::wasi::io::streams;
...
use super::{Request as ReqwestRequest, Response};
use crate::wasi::wit::wasi::http::types::*;
use crate::wasi::wit::wasi::http::types::Scheme;
use crate::wasi::wit::wasi;

// TODO(simon): no outgoing responses
...
//     fn from(method: wasi::http::types::Method) -> Self {
//         match method {
...
//             wasi::http::types::Method::Other(o) => http::Method::from_bytes(o.as_bytes()).expect("TODO"),
//         }
//     }
// }
impl From<http::Method> for wasi::http::types::Method {
    fn from(method: http::Method) -> Self {
        match method {
            http::Method::GET => wasi::http::types::Method::Get,
            http::Method::POST => wasi::http::types::Method::Post,
            http::Method::PUT => wasi::http::types::Method::Put,
            http::Method::DELETE => wasi::http::types::Method::Delete,
            http::Method::PATCH => wasi::http::types::Method::Patch,
            http::Method::HEAD => wasi::http::types::Method::Head,
            http::Method::OPTIONS => wasi::http::types::Method::Options,
            http::Method::CONNECT => wasi::http::types::Method::Connect,
            http::Method::TRACE => wasi::http::types::Method::Trace,
            m => wasi::http::types::Method::Other(m.as_str().into()),
        }
    }
}
...
impl FromBody for BoxBody<hyper::body::Bytes, crate::Error> {
    fn from_body(body: Vec<u8>) -> Self {
        BoxBody::new(super::Body::from(body))
    }
}
...
pub trait TryIntoOutgoingRequest {
    ...
    fn try_into_outgoing_request(self) -> Result<(OutgoingRequest, Option<Vec<u8>>), crate::Error>;
}
...
impl TryIntoOutgoingRequest for crate::RequestBuilder {
    type Error = crate::Error;
...
impl<B> TryIntoOutgoingRequest for hyper::Request<B>
where
    B: TryIntoBody,
...
#[async_trait]
impl<B: TryFromBody> TryFromIncomingResponse for hyper::Response<B> {
    type Error = B::Error;
    async fn try_from_incoming_response(resp: IncomingResponse) -> Result<Self, Self::Error> {
...
// impl<B: TryIntoBody> TryIntoRequest for hyper::Request<B> {
//     type Error = B::Error;
//     fn try_into_request(self) -> Result<Request, Self::Error> {
//         Ok(Request::builder()
