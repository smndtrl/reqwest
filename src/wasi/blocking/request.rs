...
// use crate::wasi::async_impl::Client;
...
impl RequestBuilder {
    ...
    pub fn send(self) -> crate::Result<super::response::Response> {
    ...
    pub fn multipart(self, mut multipart: super::multipart::Form) -> RequestBuilder {
